...
// JSON-LD for download page - SoftwareApplication schema
const downloadJsonLd = {
  "@context": "https://schema.org",
  "@type": "SoftwareApplication",
  "@id": "https://ilmiyya.com/download/#app",
  name: "المكتبة العلمية - Ilmiyya Desktop",
  alternateName: ["Ilmiyya", "Al-Maktabah Al-Ilmiyyah", "بديل الشاملة", "Shamela Alternative"],
  description: "تطبيق مكتبي للبحث في الأحاديث النبوية والكتب الإسلامية. بديل حديث للمكتبة الشاملة. Desktop application for Islamic hadith research - modern Shamela alternative.",
  applicationCategory: "EducationalApplication",
  applicationSubCategory: "Islamic Study Software",
  operatingSystem: ["Windows 10", "Windows 11"],
  downloadUrl: "https://ilmiyya.com/download",
  installUrl: "https://ilmiyya.com/download",
  softwareVersion: "1.0",
  releaseNotes: "Initial release with full hadith search and topic browsing",
  fileSize: "50MB",
  memoryRequirements: "4GB RAM recommended",
  storageRequirements: "500MB minimum",
  ...
  review: {
    ...
    reviewBody: "Excellent hadith research tool. Much better than Shamela for modern users."
  },
  author: {
    "@type": "Organization",
    name: "Ilmiyya Team",
  ...
  screenshot: "https://ilmiyya.com/logo.png",
  featureList: [
    "Advanced Arabic hadith search",
    "Topic-based hadith navigation",
    "Offline access to all books",
    "Fast and lightweight",
    "Clean modern interface",
    "Supports Sahih Bukhari, Muslim, and all major hadith books"
  ],
  keywords: "shamela, shamela alternative, hadith software, islamic library, ilmiyya, المكتبة العلمية, الشاملة, بديل الشاملة"
}
