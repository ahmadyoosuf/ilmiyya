...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center md:justify-center px-4 pt-6 md:py-12" style={{ paddingBottom: 'max(7rem, calc(4rem + env(safe-area-inset-bottom)))' }}>
